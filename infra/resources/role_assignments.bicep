...
@description('Built-in Storage Blob Data Reader role')
...
@description('Built-in Cognitive Services OpenAI Contributor role')
resource cognitive_services_openai_contributor_role 'Microsoft.Authorization/roleDefinitions@2022-04-01' existing = {
  name: 'a001fd3d-188f-4b5d-821b-7da978bf7442'
}

@description('Built-in Cognitive Services Language Owner role')
